...
import { GetTodobyId, GetTodo, InsertTodo, UpdateTodo, DeteleTodo, GetTodoSubcription} from "./queries"



function TodoList() {
  // const { data, loading, error} = useQuery(GetTodo);
  const { data, loading, error } = useSubscription(GetTodoSubcription);
